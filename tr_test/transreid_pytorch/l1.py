...
if __name__ == '__main__':
    ...
    if args.name is "":
        wandb_name = 'lr-{}-lrG-{}-L1-{}-epoch-{}-batch-{}-server-9'.format(args.lr,
                                                                            args.lrG,
    ...
    if args.strong:
        path_to_strong_G = '/storage/sjhwang/tr_test/transreid_pytorch/log/transreid/market/vit_small_ics_cfs_lup/lambda_8.0_epoch_400/transformerG_0.1_120.pth'
    ...
    if args.made:
        ...
        optimizer_G = torch.optim.Adam(modelG.parameters(), lr=args.lrG, betas=(0.5, 0.999))
        optimizer_center = None
    else:
        optimizer, optimizer_G, optimizer_center = make_optimizer(cfg, model, modelG, center_criterion)
