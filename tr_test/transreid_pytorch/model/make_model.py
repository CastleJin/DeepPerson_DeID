...
class Backbone(nn.Module):
    ...
    def forward(self, x, label=None, adv_train=False, **kwargs):  # label is unused if self.cos_layer == 'no'
        x = self.base(x)
...
class build_transformer(nn.Module):
    ...
    def forward(self, x, label=None, cam_label= None, view_label=None, adv_train=False):
