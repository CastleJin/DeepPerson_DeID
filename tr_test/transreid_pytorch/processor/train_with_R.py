    ...
    for epoch in range(1, epochs + 1):
        ...
        for n_iter, (img, vid, target_cam, target_view) in enumerate(train_loader):
            ...
            if args.use_GAN or args.use_GAN_L1:
                ...
                loss_D = args.reID_weight * (loss + loss_fake) + loss_gan_d
            ...
            if args.use_lossG:
                ...
                to_loss = loss_GAN_g
            elif args.use_GAN_L1:
                ff = dis(ch_img)
                loss_GAN_g = ganloss(ff, valid)
                to_loss = cfg.SOLVER.LAMBDA_L1*l1 + loss_GAN_g
            else:
                to_loss = args.reID_weight * (-loss_G) + cfg.SOLVER.LAMBDA_L1*l1
                ...
                if args.no_pose:
                    pose_w = 0
                to_loss += pose_w * loss_pose + loss_GAN_g
                ...
                if (n_iter + 1) % (log_period * 5) == 0:
                    if args.made:
                        ...
                        if args.use_GAN or args.use_GAN_L1:
                            ...
                            real_fake_image = wandb.Image(torch.cat((img[:1], ch_img[:1]), dim=2))  
